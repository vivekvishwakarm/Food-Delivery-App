...
class _AdminLoginState extends State<AdminLogin> {
  ...
  LoginAdmin() {
    ...
    FirebaseFirestore.instance.collection("Authentication").get().then(
      (snapshot) {
        ...
        for (var result in snapshot.docs) {
          if (result.data()['id'] == usernamecontroller.text.trim() &&
            ...
            // Navigate to HomeAdmin if id and password match
            Route route =
        ...
        // Handle the case where no document matches the credentials
        if (!isAuthenticated) {
          ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
            backgroundColor: Colors.orangeAccent,
            content: Text(
